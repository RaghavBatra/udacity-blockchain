...
contract SupplyChain {
  ...
  function harvestItem(uint _upc, address payable _originFarmerID, string memory _originFarmName, string memory _originFarmInformation, string memory  _originFarmLatitude, string memory  _originFarmLongitude, string memory _productNotes) public
  {
    ...
    // productID is UPC + SKU
    Item memory newItem = Item(sku, _upc, _originFarmerID, _originFarmerID, _originFarmName, _originFarmInformation,
       _originFarmLatitude, _originFarmLongitude, _upc + sku, _productNotes, 0, State.Harvested,
  ...
  function sellItem(uint _upc, uint _price) packed(_upc) verifyCaller(items[_upc].ownerID)
 public {
  ...
  function buyItem(uint _upc) public forSale(_upc) paidEnough(items[_upc].productPrice) checkValue2(_upc) payable {
